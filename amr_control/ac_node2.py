...
class AMRControlNode():
    def __init__(self):
        ...
        self.amr_waypoint_action_client = ActionClient(self, FollowWaypoints, '/follow_waypoints', 10)
        # AMR_NavGoal_action_client
        self.amr_navgoal_action_client = ActionClient(self, NavigateToPose, 'navigate_to_pose', 10)
        # AMR_cmd_topic_pub
        ...
        # DA_area_sub
        self.da_area_subscription  = self.create_subscription(msg.String,'navigate_to_zone',self.get_area_callback, 10)
