...
class AMRControlNode(Node):
    def __init__(self):
        ...
        # 카메라 스트리밍 토픽생성
        self.image_publisher = self.create_publisher(Image,'cctv_image',10)
        
        self.detection_publisher = self.create_publisher(msg.String,'da_track_data',10)
        self.da_alert_publisher = self.create_publisher(msg.Bool,'da_alert',10)
        ...
        self.zone_publisher = self.create_publisher(msg.String,'navigate_to_zone',10)  # Change here
